-- =====================================================================
-- SIEAGE - Esquema normalizado, listo para el boton IMPORTAR de phpMyAdmin
--
-- COMO USARLO
--   1. En phpMyAdmin: Nueva -> nombre de la base -> Cotejamiento
--      utf8mb4_unicode_ci -> Crear
--   2. Con esa base seleccionada, pestana "Importar" -> elegir este
--      archivo -> Juego de caracteres: utf8mb4 -> Continuar
--
-- No lleva CREATE DATABASE ni USE: las tablas se crean en la base que
-- tengas seleccionada. El orden ya respeta las claves foraneas, asi que
-- se importa de una sola vez.
-- =====================================================================
